...
**Чтобы клонировать внешний репозиторий на локальный ПК, используйте команду:**

```
git clone <url-адрес репозитория>
```

**Чтобы получить изменения и слияние с локальной версией версии в удалённом репозитории, используйте команду:**
